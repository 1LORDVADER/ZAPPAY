...
const BUSINESS_TYPE_LABELS: Record<string, { label: string; color: string; icon: React.ReactNode }> = {
  ...
  distributor: { label: 'Distributor', color: 'bg-blue-100 text-blue-900', icon: <Package className="h-3 w-3" /> },
      ...
      <div className="max-w-7xl mx-auto px-6 py-8 space-y-6">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
          {[
            ...
            { label: 'Distributors', value: counts.distributor, color: 'bg-blue-700 text-white' },
